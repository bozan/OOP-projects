...
int main(){
    ...
    Courier c4 = Courier("Courier", "surname4", "bcycle");
    ...
    Courier cour = atlas[3];
    atlas.fire_courier(cour);
    Courier cour1 = atlas[0];
    atlas.fire_courier(cour1);
    Courier cour2 = atlas[0];
    atlas.fire_courier(cour2);
    Courier cour3 = atlas[1];
    atlas.fire_courier(cour3);
